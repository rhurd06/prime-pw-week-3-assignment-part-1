...
let favoriteFoods= ['pasta', 'seafood', 'veggies']
...
console.log('Added another favorite food to the array', favoriteFoods);
...
console.log('The foods in my array are now:', favoriteFoods);
